...
function validaNombre() {
  ...
  if (nombreInput.value === "") {
    ...
    //Verificamos que el nombre siga la regexp (solo letras)
    nombreError.textContent =
      "El formato del nombre no es válido, inténtalo de nuevo";
    inputLine.classList.add("invalid");
    inputLine.classList.remove("valid");
  } else {
    nombreError.textContent = "";
...
function validaApellido1() {
  ...
  if (apellido1Input.value === "") {
    ...
    //Verificamos que el nombre siga la regexp (solo letras y vocales con tílde)
    apellido1Error.textContent =
      "El formato del apellido no es válido, inténtalo de nuevo";
    inputLine.classList.add("invalid");
    inputLine.classList.remove("valid");
  } else {
    apellido1Error.textContent = "";
...
function validaEmail() {
  ...
  if (emailInput.value === "") {
    ...
    //Verificamos que el nombre siga la regexp para que cumpla con el formato de un correo electrónico
    emailError.textContent =
      "El formato del correo electrónico no es válido, inténtalo de nuevo";
    inputLine.classList.add("invalid");
    inputLine.classList.remove("valid");
  } else {
    emailError.textContent = "";
...
function validaPassword() {
  ...
  if (passwordInput.value === "") {
    ...
    //Valida que la contraseña tenga entre 4 y 8 caracteres
    passError.textContent =
      "La contraseña que has introducido es incorrecta, debe tener entre 4 y 8 caracteres";
    inputLine.classList.add("invalid");
    inputLine.classList.remove("valid");
  } else {
    passError.textContent = "";
